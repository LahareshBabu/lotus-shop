                  ...
                  <table className="w-full text-left text-sm relative">
                      <thead className="bg-[#1a0505] text-[#e5d5a3]/50 uppercase text-[10px] tracking-widest sticky top-0 z-10 shadow-lg">
                          <tr>
                              ...
                              <th className="p-4 font-normal">Overall Status</th>
                          </tr>
                      </thead>
                      <tbody className="divide-y divide-[#e5d5a3]/5">
                          {orders.map(order => {
                              ...
                              // 🌟 NEW BINARY STATUS LOGIC 🌟
                              // Since order.status only becomes 'Delivered' when ALL items are delivered
                              ...
                              return (
                                  <tr key={order.id} className="hover:bg-[#e5d5a3]/5 transition-colors">
                                      ...
                                      <td className="p-4"><Link href={`/admin/order/${order.id}`} className="text-[10px] border border-[#e5d5a3]/30 px-3 py-1 rounded hover:bg-[#c5a059] hover:border-[#c5a059] hover:text-[#1a0505] transition-all uppercase tracking-widest shadow-md">View Items</Link></td>
                                      <td className="p-4">
                                          {/* 🌟 THE NEW ADMIN BADGE 🌟 */}
                                          {isFullyDelivered ? (
                                              <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded text-[10px] font-bold uppercase tracking-widest bg-emerald-500/10 text-emerald-400 border border-emerald-500/30 shadow-md">
                                                  <CheckCircleIcon className="w-3 h-3" /> Fully Delivered
                                              </span>
                                          ) : (
                                              <span className="inline-flex items-center px-3 py-1.5 rounded text-[10px] font-bold uppercase tracking-widest bg-[#c5a059]/10 text-[#c5a059] border border-[#c5a059]/30 shadow-md">
                                                  Pending Delivery
                                              </span>
                                          )}
                                      </td>

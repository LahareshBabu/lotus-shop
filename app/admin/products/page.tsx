...
// 🌟 NEW: Edit Icon for Phase 2.1 🌟
function EditIcon({ className="w-5 h-5" }) { return <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0115.75 21H5.25A2.25 2.25 0 013 18.75V8.25A2.25 2.25 0 015.25 6H10" /></svg> }
          ...
          <div className="divide-y divide-[#e5d5a3]/10">
            {filteredProducts.map((product) => (
              <div key={product.id} className="grid grid-cols-1 md:grid-cols-[100px_1fr_auto_auto_auto] gap-6 items-center p-6 hover:bg-[#c5a059]/5 transition-colors">
                ...
                {/* 🌟 NEW: View, Edit, & Delete Buttons Container 🌟 */}
                <div className="flex gap-2 w-full md:w-auto">
                  ...
                  {/* 🌟 THE NEW EDIT BUTTON 🌟 */}
                  <Link 
                    href={`/admin/upload?id=${product.id}`} 
                    className="px-4 py-2.5 border border-[#c5a059]/50 bg-[#c5a059]/10 text-[#c5a059] rounded hover:bg-[#c5a059] hover:text-[#1a0505] transition-colors flex items-center justify-center"
                    title="Edit Treasure Details"
                  >
                  ...
                  <button 
                    ...
                    className="px-4 py-2.5 border border-red-900 bg-red-950/50 text-red-500 rounded hover:bg-red-600 hover:text-white transition-colors flex items-center justify-center"

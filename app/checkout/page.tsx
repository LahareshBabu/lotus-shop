...
// 🌟 FIX: Force dynamic rendering to prevent build errors
...
// 🌟 FIX: Renamed from CheckoutPage to CheckoutContent
...
export default function CheckoutPage() {
  return (
    <Suspense fallback={<div className="min-h-screen bg-[#1a0505] flex items-center justify-center text-[#c5a059]">Loading Checkout...</div>}>
      <CheckoutContent />
    </Suspense>
  )
}